...
export const PORT_RULES: PortRule[] = [
  ...
  { id: "damage", type: "command", scope: "datapack", match: "damage", since: "1.19.4", description: "the /damage command", guidance: "Use /effect with instant damage, /attribute, or /data to apply damage in older versions.", note: "Added in 23w06a (1.19.4)" },
  ...
  { id: "execute_rotated", type: "command_pattern", scope: "datapack", match: "^/?(?:execute\\b.*\\b)rotated\\s+(?:as|over)\\b", since: "1.19.4", description: "/execute rotated requires 1.19.4+", guidance: "Use /execute at with rotation modifiers for pre-1.19.4.", note: "execute rotated as/over added in 1.19.4" },
  ...
  { id: "execute_rotated_comment", type: "command", scope: "datapack", match: "execute", description: "/execute rotated as/over commented out (pre-1.19.4)", fix: { kind: 'rewrite', pattern: /^\/execute\s+.*\s+rotated\s+(?:as|over)\s/, replacement: "## FIXED(/execute rotated requires 1.19.4+): $0", sourceSince: "1.19.4", targetUntil: "1.19.3" } },
