 ...
 *
 * Version facts sourced from the Minecraft Wiki command history and community
 * datapack-porting knowledge. Each rule maps a detectable content pattern to the
 * minimum version that supports it.
 */
export const FEATURE_RULES: FeatureRule[] = [
  // ---- Commands added in 1.13 (The Flattening) ----
  {
    id: 'tag',
  ...
  // ---- Commands added in 1.14 (Village & Pillage) ----
  {
    id: 'loot',
  ...
  // ---- Commands added in 1.15 (Buzzy Bees) ----
  {
    id: 'spectate',
  ...
  // ---- Commands added in 1.16 (Nether Update) ----
  {
    id: 'locatebiome',
  ...
  // ---- Commands added in 1.17 (Caves & Cliffs Pt.1) ----
  {
    id: 'item_cmd',
  ...
  // ---- Commands added in 1.20.2 (23w31a) ----
  {
    id: 'random',
  ...
  // ---- Commands added in 1.19.4 (23w03a / 23w06a) ----
  {
    id: 'damage',
  ...
  // ---- Commands added in 1.19.3 (22w46a) ----
  {
    id: 'fillbiome',
  ...
  // ---- Command added in 1.20.3 (23w43a) ----
  {
    id: 'tick',
  ...
  // ---- Command added in 1.20.5 (24w04a) ----
  {
    id: 'transfer',
  ...
  // ---- Item components rework (1.20.5, 24w09a) ----
  {
  ...
  // ---- Commands added in 1.21.4 (test framework) ----
  {
    id: 'test_command',
  ...
  // ---- Command added in 1.21.2 (24w40a) ----
  {
    id: 'rotate',
  ...
  // ---- Commands added in 1.21.6 (25w15a / 25w20a) ----
  {
    id: 'version_cmd',
  ...
  // ---- Command added in 1.21.9 (25w34a) ----
  {
    id: 'fetchprofile',
  ...
  // ---- Commands added in 26.x (snapshots) ----
  {
    id: 'swing',
  ...
  // ---- Item component sub-features (require newer versions than the 1.20.5 base) ----
  {
  ...
  // ---- Execute subcommand patterns (version-gated) ----
  {
